...
```text
O cliente consegue ver os produtos, buscar itens e filtrar por categoria.
```

Mostre busca e filtros.
...
```text
Ao adicionar produtos, o app monta o carrinho e calcula o total automaticamente.
```
